...
### Assignmnet Instructions

This assignment uses data from the UC Irvine Machine Learning Repository, a popular repository for machine learning datasets. We are asked to  be use the “Individual household electric power consumption Data Set” which I have downloaded to by computer.

#### Dataset: Electric power consumption - Description: 
...
You will check the following while reviewing your collegues assignments:
