##runAnalysis.r file
## In this file first we read the UCI dataset, then we read subject_train and test.data 
...
# Reading labels of the test and train datasets
...
# 1. Extracts only the measurements on the mean and standard deviation for each measurement. (Before mergering, subset the dataset and save time and space.) )
